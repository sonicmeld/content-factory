                    ...
                    <div className="bg-card border border-border rounded-lg shadow-lg w-full max-w-md overflow-hidden">
                        <div className="flex items-center justify-between p-4 border-b border-border">
                            <h2 className="font-semibold text-lg flex items-center gap-2">
                                <PlusCircle className="w-5 h-5 text-primary" /> Observe Competitor Channel
                            </h2>
                            <button 
                        ...
                        <form onSubmit={handleObserveSubmit}>
                            <div className="p-4 space-y-4">
                                <div className="space-y-2">
                                    ...
                                    {/* UI Refinement: Analytics Type & Workspace Channel Assignment are no longer needed
                                    since owned channels are synced automatically via YouTube Accounts Identity Layer.
                                    We keep the code commented out just in case it's needed in the future.
                                    <div className="space-y-2">
